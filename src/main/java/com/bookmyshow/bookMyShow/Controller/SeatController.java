...
public class SeatController {
	...
	@PostMapping
	ResponseEntity<ResponseStructure<Seat>> saveSeat(@RequestBody Seat seat){
	...
	@PutMapping
	ResponseEntity<ResponseStructure<Seat>> updateSeat(@RequestBody Seat seat,@RequestParam int seatId){
